...
review2 = Review.create(customer_id: hema.id, restaurant_id: bombay_pizza.id, content: "Bombay Pizza Co. is average but super affordable.", rating: 3, affordability: 6)
