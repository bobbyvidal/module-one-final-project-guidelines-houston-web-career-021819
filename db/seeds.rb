...
review1 = Review.create(customer_id: alan.id, restaurant_id: bobs_burgers.id, restaurant_name: bobs_burgers.name, content: "This place is very bad and there is a girl names Tina that is very weird and awkward.", rating: 1, affordability: 4)
#problem with our validator and auto-value setter
review2 = Review.create(customer_id: hema.id, restaurant_id: bombay_pizza.id, restaurant_name: bombay_pizza.name, content: "Bombay Pizza Co. is average but super affordable.", rating: 3, affordability: 5)
review3 = Review.create(customer_id: bobby.id, restaurant_id: pollys_pasta.id, restaurant_name: pollys_pasta.name, content: "Polly's really knows how to overprice their food.", rating: 4, affordability: 1)
review4 = Review.create(customer_id: jack.id, restaurant_id: hibachi_heaven.id, restaurant_name: hibachi_heaven.name, content: "This place is wicked bad.", rating: 2, affordability: 1)
review5 = Review.create(customer_id: eli.id, restaurant_id: taqueria_barba.id, restaurant_name: taqueria_barba.name, content: "Best food I've ever had!", rating: 5, affordability: 5)
